...
static inline UIImage * GetImageWithName(NSString *name) {
    ...
    return [UIImage imageNamed:kZLPhotoBrowserSrcName(name)]?[UIImage imageNamed:kZLPhotoBrowserSrcName(name)] : ([UIImage imageNamed:kZLPhotoBrowserFrameworkSrcName(name)] ? [UIImage imageNamed:kZLPhotoBrowserFrameworkSrcName(name)] : [UIImage imageNamed:name]);
}
